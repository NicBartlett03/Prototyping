...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double resizeImageWidth = 297.0;
		double resizeImageHeight = 219.0;
		int resizeImageInterpolation = Imgproc.INTER_CUBIC;
		resizeImage(resizeImageInput, resizeImageWidth, resizeImageHeight, resizeImageInterpolation, resizeImageOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = resizeImageOutput;
		double[] hsvThresholdHue = {89.02877697841726, 113.95904436860067};
		double[] hsvThresholdSaturation = {20.0, 255.0};
		double[] hsvThresholdValue = {23.38129496402877, 255.0};
