...
public class OI {
  ...
  public OI(){
    ...
    pilotButtonA.whileHeld(new IntakeHatch());
    pilotButtonA.whenReleased(new StopHatch());

    Button pilotButtonY = new JoystickButton(pilotController, RobotMap.joystickButtonY);
    pilotButtonY.whileHeld(new ReleaseHatch());
    pilotButtonY.whenReleased(new StopHatch());
